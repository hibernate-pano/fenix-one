...
public class GlobalExceptionHandler {
    ...
    public FebsResponse handleParamsInvalidException(FebsException e) {
        ...
        return new FebsResponse().code(cn.hutool.http.HttpStatus.HTTP_INTERNAL_ERROR).message(e.getMessage());
    }
    ...
    public FebsResponse handleException(Exception e) {
        ...
        return new FebsResponse().code(cn.hutool.http.HttpStatus.HTTP_INTERNAL_ERROR).message("系统内部异常");
    }
    ...
    public FebsResponse validExceptionHandler(BindException e) {
        ...
        return new FebsResponse().code(cn.hutool.http.HttpStatus.HTTP_BAD_REQUEST).message(message.toString());
    ...
    public FebsResponse handleLimitAccessException(LimitAccessException e) {
        ...
        return new FebsResponse().code(cn.hutool.http.HttpStatus.HTTP_REQ_TOO_LONG).message(e.getMessage());
    }
