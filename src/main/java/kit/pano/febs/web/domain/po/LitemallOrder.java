...
public class LitemallOrder extends Model<LitemallOrder> {
    ...
    @ApiModelProperty(value = "订单状态1待付款2待发货3待配送4待核销5待评价6已完成7已取消8已退款10无效")
    ...
    @ApiModelProperty(value = "付款状态1未支付2支付中3已支付0已退款")
